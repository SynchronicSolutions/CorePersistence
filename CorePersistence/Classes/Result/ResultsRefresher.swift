...
public typealias ChangesBlock<ObjectType: PersistableManagedObject>
    = ([ResultsRefresher<ObjectType>.Change], Results<ObjectType>?) -> Void
...
public class ResultsRefresher<EntityType: PersistableManagedObject>: NSObject, NSFetchedResultsControllerDelegate {
    ...
    private var accumulatedChanges: ([Change], Results<EntityType>) -> Void

    weak var results: Results<EntityType>?
    ...
    init(results: Results<EntityType>,
         accumulatedChanges: @escaping ([Change], Results<EntityType>) -> Void) {
